...
// DeleteAccessKeyParams contains all the bound params for the delete access key operation
...
func (o *DeleteAccessKeyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *DeleteAccessKeyParams) bindAccessKeyID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAccessKeyParams) bindSignature(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAccessKeyParams) bindSignatureMethod(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAccessKeyParams) bindSignatureNonce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAccessKeyParams) bindSignatureVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAccessKeyParams) bindTimestamp(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAccessKeyParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAccessKeyParams) bindKeyID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
