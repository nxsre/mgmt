...
// NewDelPolicyParams creates a new DelPolicyParams object
// with the default values initialized.
func NewDelPolicyParams() DelPolicyParams {
	var ()
	return DelPolicyParams{}
}

// DelPolicyParams contains all the bound params for the del policy operation
// typically these are obtained from a http.Request
//
// swagger:parameters delPolicy
type DelPolicyParams struct {
...
func (o *DelPolicyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *DelPolicyParams) bindAccessKeyID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DelPolicyParams) bindSignature(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DelPolicyParams) bindSignatureMethod(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DelPolicyParams) bindSignatureNonce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DelPolicyParams) bindSignatureVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DelPolicyParams) bindTimestamp(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DelPolicyParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DelPolicyParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
